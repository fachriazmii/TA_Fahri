            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="#">
                            <div class="mb-3">
                                <label for="id" class="form-label">Kode Matakuliah</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="number" min="0" max="50"name="sks" id="sks">
                            </div>
                            <div class="mb-3">
                                <label for="semester" class="form-label">Semester</label>
                                <input class="form-control" type="number" min="1" max="24" name="semester" id="semester">
                            </div>
